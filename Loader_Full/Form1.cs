...
namespace Bolso_naro
{
    public partial class lieth : Form
    {
        ...
        private void guna2ToggleSwitch3_CheckedChanged(object sender, EventArgs e)
        {
            PSPS.Text = "Conectando...";
            PSPS.ForeColor = Color.Orange;
            DRIERSSSS_LOAD_AUTO_IN_PROCESSS("VERMELHAO");
        }
        ...
        private void guna2ToggleSwitch5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            ProcessStartInfo info = new ProcessStartInfo()
            {
                FileName = "CMD.exe",
                Arguments =
            "/C taskkill /im qsdftgbnjuyhn.exe /f", //App Name 
                CreateNoWindow = true,
        ...
        private void lieth_Load(object sender, EventArgs e)
        {
